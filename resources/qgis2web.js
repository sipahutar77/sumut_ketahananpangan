...
map.getView().fit([10606636.662627, -84864.798247, 11378064.071434, 493199.777512], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Peta Klaster Potensi Kecamatan di Provinsi Sumatera Utara</h2>';
        return titleElement;
    })(),
...
var searchLayer = new SearchLayer({
    layer: lyr_KlasterPotensiProvinsiSumateraUtara_5,
    colName: 'WADMKC',
    zoom: 10,
    collapsed: true,
    map: map,
